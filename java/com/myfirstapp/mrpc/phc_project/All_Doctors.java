...
public class All_Doctors extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_all__doctors, container, false);
        auth = FirebaseAuth.getInstance();
        recyclerView = v.findViewById(R.id.AlldoctorRecycler);
        manager = new LinearLayoutManager(getActivity());
        list = new ArrayList<>();
        recyclerView.setLayoutManager(manager);
        valu = v.findViewById(R.id.NoofDoc);
        fetchData();
        btn = v.findViewById(R.id.allDocsignout);
